const utils = {
  ...
  transArrFromDecToHex(numArray) {
    return numArray.map(num => num.toString(16).padStart(2, '0').toUpperCase());
  },

  transArrFromHexToDec(hexArray) {
